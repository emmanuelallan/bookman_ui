...
import { BsJournalPlus, BsBoxArrowRight } from 'react-icons/bs';
      ...
      <nav className="flex items-center justify-between px-5 py-4 md:px-8">
        ...
        <div className="flex items-center space-s-8">
          ...
          <div className="relative inline-block text-left ml-6">
            ...
            <ul
              className="absolute end-0 w-48 mt-1 origin-top-end bg-white rounded shadow-md right-0 focus:outline-none"
            ...
            >
              <li className="w-full flex flex-col space-y-1 bg-[#00b791] text-white text-sm rounded-t px-4 py-3">
                ...
                <span className="text-xs">admin@demo.com</span>
              </li>
              <li className="border-b border-gray-100 cursor-pointer last:border-0">
                <Link
                  to="/"
                  className="flex items-center px-4 py-3 text-sm capitalize font-semibold transition duration-200 hover:text-accent text-heading"
                >
                  <BsBoxArrowRight /> <span className="ml-2">Logout</span>
                </Link>
              </li>
            </ul>
          </div>
